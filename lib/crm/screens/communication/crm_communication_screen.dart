...
class CrmCommunicationScreen extends StatelessWidget {
  final VoidCallback? onBack;

  const CrmCommunicationScreen({super.key, this.onBack});
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          _buildPillFilter('Inbox', false),
                          _buildPillFilter('Sent', false),
                          _buildPillFilter('Drafts', false),
                        ],
                      ),
                    ),
                  ],
