...
class CrmQuotesScreen extends StatelessWidget {
  final VoidCallback? onBack;

  const CrmQuotesScreen({super.key, this.onBack});
          ...
          slivers: [
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          _buildPillFilter('Draft', false),
                          _buildPillFilter('Sent', false),
                          _buildPillFilter('Paid', false),
                          _buildPillFilter('Overdue', false),
                        ],
                      ),
                    ),
                  ],
            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Row(
                  children: [
                    Expanded(flex: 5, child: _buildListHeader('QUOTE #')),
                    Expanded(flex: 3, child: _buildListHeader('TOTAL')),
