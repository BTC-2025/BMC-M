          ...
          slivers: [
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          _buildPillFilter('Due Today', false),
            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Row(
                  children: [
                    Expanded(flex: 5, child: _buildListHeader('TASK')),
                    Expanded(flex: 3, child: _buildListHeader('DUE DATE')),
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Center(
                    child: Icon(
                      isCompleted ? Icons.check : Icons.priority_high_rounded,
