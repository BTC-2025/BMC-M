...
class CrmCampaignsScreen extends StatelessWidget {
  final VoidCallback? onBack;

  const CrmCampaignsScreen({super.key, this.onBack});
          ...
          slivers: [
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: CrmHeader(
                  title: 'Campaigns',
                  subtitle: 'Marketing Initiatives',
                  onBack: onBack,
                ),
              ),
            ),
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          _buildPillFilter('Planned', false),
            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Row(
                  children: [
                    Expanded(flex: 5, child: _buildListHeader('CAMPAIGN')),
                    Expanded(flex: 3, child: _buildListHeader('BUDGET')),
                    Expanded(flex: 2, child: _buildListHeader('LEADS')),
