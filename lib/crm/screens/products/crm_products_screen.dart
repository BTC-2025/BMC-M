...
class CrmProductsScreen extends StatelessWidget {
  final VoidCallback? onBack;

  const CrmProductsScreen({super.key, this.onBack});
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          _buildPillFilter('Services', false),
                          _buildPillFilter('Software', false),
                          _buildPillFilter('Hardware', false),
                        ],
                      ),
                    ),
                  ],
