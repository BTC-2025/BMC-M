...
class StockScreen extends StatelessWidget {
  ...
  Widget _buildStockTile(int index) {
    final bool isLowStock = index % 4 == 0;
    final String stockStatus = isLowStock ? 'Low Stock' : 'In Stock';
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Iconsax.box, color: iconColor, size: 24),
          ),
