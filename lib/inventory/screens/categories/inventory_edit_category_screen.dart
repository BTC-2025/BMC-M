...
class InventoryEditCategoryScreen extends StatelessWidget {
  const InventoryEditCategoryScreen({super.key});
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildStyledTextField(initialValue: 'Electronics'),
                      const SizedBox(height: 24),
                      _buildLabel('Description'),
                      const SizedBox(height: 8),
                      _buildStyledTextField(
                        initialValue: 'Devices and gadgets',
                        maxLines: 3,
                      ),
                      const SizedBox(height: 24),
                      _buildLabel('Icon'),
