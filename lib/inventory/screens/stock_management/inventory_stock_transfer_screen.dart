...
class InventoryStockTransferScreen extends StatelessWidget {
  final VoidCallback? onBack;

  const InventoryStockTransferScreen({super.key, this.onBack});
          ...
          slivers: [
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          _buildPillFilter('In Transit', false),
            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Row(
                  children: [
                    Expanded(flex: 5, child: _buildListHeader('TRANSFER #')),
                    Expanded(flex: 3, child: _buildListHeader('FROM → TO')),
          ...
          Expanded(
            ...
            child: Center(
              child: Container(
                ...
                child: Text(
                  isCompleted ? 'Done' : (isInTransit ? 'Transit' : 'Pending'),
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    color: isCompleted
