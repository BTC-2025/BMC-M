...
class InventoryStockInScreen extends StatelessWidget {
  final VoidCallback? onBack;

  const InventoryStockInScreen({super.key, this.onBack});
          ...
          slivers: [
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: InventoryHeader(
                  title: 'Stock In',
                  subtitle: 'Receive & Add Inventory',
                  onBack: onBack,
                ),
              ),
            ),
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          _buildPillFilter('Today', false),
                          _buildPillFilter('This Week', false),
                          _buildPillFilter('This Month', false),
                        ],
                      ),
                    ),
                  ],
            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Row(
                  children: [
                    Expanded(flex: 5, child: _buildListHeader('RECEIPT')),
                    Expanded(flex: 3, child: _buildListHeader('QUANTITY')),
                    Expanded(flex: 2, child: _buildListHeader('DATE')),
