...
class InventoryStockOutScreen extends StatelessWidget {
  final VoidCallback? onBack;

  const InventoryStockOutScreen({super.key, this.onBack});
          ...
          slivers: [
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: InventoryHeader(
                  title: 'Stock Out',
                  subtitle: 'Sales & Dispatch Records',
                  onBack: onBack,
                ),
              ),
            ),
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          _buildPillFilter('Sales', false),
                          _buildPillFilter('Returns', false),
                          _buildPillFilter('Damaged', false),
                        ],
                      ),
                    ),
                  ],
            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Row(
                  children: [
                    Expanded(flex: 5, child: _buildListHeader('DISPATCH')),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        isSale ? 'Order #${1000 + index}' : 'Return/Damage',
                        style: const TextStyle(
                          color: Color(0xFFA3AED0),
                          fontSize: 11,
