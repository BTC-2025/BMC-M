...
class InventoryAdjustmentsScreen extends StatelessWidget {
  ...
  const InventoryAdjustmentsScreen({super.key, this.onBack});
          ...
          slivers: [
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: InventoryHeader(
                  title: 'Adjustments',
                  subtitle: 'Stock Corrections & Audits',
                  onBack: onBack,
                ),
              ),
            ),
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          _buildPillFilter('Damage', false),
                          _buildPillFilter('Loss', false),
                          _buildPillFilter('Audit', false),
                        ],
                      ),
                    ),
                  ],
            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Row(
                  children: [
                    Expanded(flex: 5, child: _buildListHeader('ADJUSTMENT #')),
                    Expanded(flex: 3, child: _buildListHeader('REASON')),
                    Expanded(flex: 2, child: _buildListHeader('QTY')),
  ...
  Widget _buildListItem(BuildContext context, int index) {
    List<String> reasons = ['Damage', 'Loss', 'Audit', 'Found'];
    String reason = reasons[index % reasons.length];
    bool isNegative = reason == 'Damage' || reason == 'Loss';
