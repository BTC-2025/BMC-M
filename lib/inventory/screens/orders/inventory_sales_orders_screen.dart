...
class InventorySalesOrdersScreen extends StatelessWidget {
  final VoidCallback? onBack;

  const InventorySalesOrdersScreen({super.key, this.onBack});
          ...
          slivers: [
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          _buildPillFilter('Processing', false),
                          _buildPillFilter('Completed', false),
                        ],
                      ),
                    ),
                  ],
            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Row(
                  children: [
                    Expanded(flex: 5, child: _buildListHeader('ORDER #')),
                    Expanded(flex: 3, child: _buildListHeader('CUSTOMER')),
  ...
  Widget _buildListItem(BuildContext context, int index) {
    bool isCompleted = index % 4 == 0;
    bool isPending = index % 4 == 1;
          ...
          Expanded(
            ...
            child: Center(
              child: Container(
                ...
                child: Text(
                  isCompleted ? 'Done' : (isPending ? 'Pending' : 'Processing'),
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    color: isCompleted
